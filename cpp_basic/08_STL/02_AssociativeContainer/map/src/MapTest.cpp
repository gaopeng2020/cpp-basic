...
void pairConstructTest()
{
    ...
    // 调用拷贝构造函数
    const pair<string, string>& pair3(pair2);
...
{
    map<string, uint8_t, less<>> students;
...
void removeElementTest(map<string, uint8_t> &other)
{
