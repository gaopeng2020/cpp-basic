...
list<int> addElementsTest() {
    cout<<"================List Add Element Test================"<<endl;
    list<int> list1;
    list1.push_front(1);
    list1.push_back(2);
    ...
    list1.sort([](const int &l, const int &r) { return l > r; }); // Lambda自定义排序规则
...
void iteratorTest() {
     ...
     */
    list<char> values{'h', 't', 't', 'p', ':', '/', '/', 'c', '.', 'b', 'i', 'a', 'n', 'c', 'h', 'e', 'n', 'g', '.',
                      'n', 'e', 't'};
...
void removeElementTest() {
    cout<<"List Remove Element Test"<<endl;
