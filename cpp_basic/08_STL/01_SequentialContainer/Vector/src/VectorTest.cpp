...
void constructTest() {
    cout << "================Vector Construct Test================" << endl;
...
void addElementsTest() {
    cout << "================Vector Add Element Test================" << endl;
    vector<int> vect;
...
void iteratorTest() {
    cout << "================Vector iterator Test================" << endl;
    /*   vector 支持迭代器的成员函数
      成员函数	功能
    ...
    auto *xiaolv = new Student("xiaolv", 14, "Shool4");
    students.emplace_back(*xiaolv);

    students.insert(students.end(),{{"xiaoma", 15, "Shool5"},{"xiaoniu", 13, "Shool3"}});
...
void removeElementTest() {
    cout << "================Vector Remove Element Test================" << endl;
    ...
    uint32_t *data1 = u16Vector.data();
    cout << "u16Vector.data()+2 = " << *(data1 + 2) << endl;
