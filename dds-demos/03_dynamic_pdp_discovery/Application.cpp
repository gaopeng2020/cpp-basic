...
std::shared_ptr<Application> Application::make_app(const CLIParser::ds_example_config& config) {
    ...
    case CLIParser::EntityKind::SUBSCRIBER:
        ...
        break;
    case CLIParser::EntityKind::SD_SERVER:
        entity = std::make_shared<PDPServerApp>(config.srv_config);
        break;
