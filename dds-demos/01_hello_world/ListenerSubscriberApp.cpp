...
void ListenerSubscriberApp::on_subscription_matched(DataReader* /*reader*/, const SubscriptionMatchedStatus& info) {
...
// run() 只是阻塞，等待 stop() 被调用才结束，有订阅者时在on_subscription_matched中处理， 数据在on_data_available中处理
