...
bool HelloWorldPubSubType::serialize(const void* const data, SerializedPayload_t& payload,
...
uint32_t HelloWorldPubSubType::calculate_serialized_size(const void* const data,
                                                         DataRepresentationId_t data_representation) {
    try {
...
void* HelloWorldPubSubType::create_data() { return reinterpret_cast<void*>(new ::HelloWorld()); }

void HelloWorldPubSubType::delete_data(void* data) { delete (reinterpret_cast<::HelloWorld*>(data)); }

bool HelloWorldPubSubType::compute_key(SerializedPayload_t& payload, InstanceHandle_t& handle, bool force_md5) {
...
bool HelloWorldPubSubType::compute_key(const void* const data, InstanceHandle_t& handle, bool force_md5) {
